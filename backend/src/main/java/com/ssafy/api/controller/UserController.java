...
public class UserController {
	...
	/*@PostMapping()
	@ApiOperation(value = "회원 가입", notes = "<strong>교사 아이디와 패스워드</strong>를 통해 회원가입 한다.")
    @ApiResponses({
	...
	public ResponseEntity<UserRes> getTeacherInfo(@ApiIgnore Authentication authentication) {
		/**
